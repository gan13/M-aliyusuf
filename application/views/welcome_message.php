...
<head>
  ...
  <!-- Bootstrap 3.3.6 -->
  <link rel="stylesheet" href=" <?php base_url(); ?> boots/bootstrap/css/bootstrap.min.css">
    <!-- Font Awesome Icons -->
  ...
  <!-- jvectormap -->
  <link rel="stylesheet" href=" <?php base_url(); ?> boots/plugins/jvectormap/jquery-jvectormap-1.2.2.css">
  <!-- Theme style -->
  <link rel="stylesheet" href=" <?php base_url(); ?> boots/dist/css/AdminLTE.min.css">
...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="<?php echo base_url(); ?>boots/index2.html" class="logo">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <?php
              ...
              '
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="'.base_url().'boots/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
              <span class="hidden-xs">Alexander Pierce</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="'.base_url().'boots/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="<?php echo base_url();?>a_beranda">
        ...
        <li class="treeview">
          <a href="<?php echo base_url();?>contoh">
            <i class="fa fa-laptop"></i>
            <span>contoh</span>
            <i class="fa fa-angle-left pull-right"></i>
          </a>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url(); ?>boots/index.html"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>
            <li><a href="<?php echo base_url(); ?>boots/index2.html"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>
          </ul>
        </li>
        ...
        <li><a href="<?php echo base_url(); ?>boots/documentation/index.html"><i class="fa fa-book"></i> <span>Documentation</span></a></li>
